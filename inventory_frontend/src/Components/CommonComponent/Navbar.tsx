...
export const Navbar: React.FC<NavbarProps> = ({ siteName = "HybridLocal" }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a
              href="/"
              className="flex items-center gap-1.5 text-sm font-medium text-gray-700 hover:text-burgundy transition-colors duration-200"
            >
            ...
            {!isLoggedIn ? (
              ...
              <>
                <button
                  ...
                  className="flex items-center gap-1.5 text-sm font-medium text-gray-700 hover:text-burgundy transition-colors duration-200 cursor-pointer"
                >
                  <LayoutDashboard size={18} className="text-camel" />
                  Dashboard
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-sm font-medium text-gray-700 hover:text-burgundy transition-colors duration-200 cursor-pointer"
                >
                  <Package size={18} className="text-camel" />
                  Products
                </button>
                  ...
                  <AnimatePresence>
                    {isProfileDropdownOpen && (
                      ...
                      >
                        ...
                        <a
                          href="#profile"
                          className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-off-white hover:text-burgundy transition-colors"
                        >
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            >
              <Home
                size={20}
                className="text-camel group-hover:text-off-white"
              />
              Home
            </a>
            ...
            {!isLoggedIn ? (
              ...
              <>
                <button
                  ...
                  className="flex items-center gap-3 px-3 py-2.5 rounded-md text-base font-medium text-gray-700 hover:bg-burgundy hover:text-off-white transition-all group"
                >
                  <LayoutDashboard size={18} className="text-camel group-hover:text-off-white" />
                  Dashboard
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-3 px-3 py-2.5 rounded-md text-base font-medium text-gray-700 hover:bg-burgundy hover:text-off-white transition-all group"
                >
                  <Package size={18} className="text-camel group-hover:text-off-white" />
                  Products
                </button>
